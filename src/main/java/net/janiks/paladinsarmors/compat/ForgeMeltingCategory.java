...
public class ForgeMeltingCategory implements IRecipeCategory<ThePrimordiumForgeRecipe> {
    ...
    public static final RecipeType<ThePrimordiumForgeRecipe> PRIMORDIUM_FORGE_RECIPE_RECIPE_TYPE =
            new RecipeType<>(UID, ThePrimordiumForgeRecipe.class);
    private final IDrawable background;
    private final IDrawable icon;

    public ForgeMeltingCategory(IGuiHelper helper) {
    ...
    public RecipeType<ThePrimordiumForgeRecipe> getRecipeType() {
        return PRIMORDIUM_FORGE_RECIPE_RECIPE_TYPE;
    }
